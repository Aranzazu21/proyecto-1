...
public class QuadraticAgent extends OneShotBehaviour {
    private PolynomialRegression polynomial;

    public QuadraticAgent(PolynomialRegression polynomial) {
    ...
    public void action() {
        ...
        System.out.println("QUADRATIC POLYNOMIAL REGRESSION:");
