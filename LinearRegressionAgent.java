...
public class LinearRegressionAgent extends OneShotBehaviour {
    ...
    public LinearRegressionAgent(LinearRegression maths) {
        this.simpleLinearRegression = maths;
    }
    ...
    public void action() {
        ...
        System.out.printf("ERROR ESTANDAR BETA 0 (SE_B0) = %.4f%n", simpleLinearRegression.getSEIntercept());
